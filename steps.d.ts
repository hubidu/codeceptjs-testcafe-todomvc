...
declare namespace CodeceptJS {
  ...
  export interface Todos02Page {
    goto() : void,
    enterTodo(todo: string) : void,
    seeNumberOfTodos(numberOfTodos: string) : void,

  }


  export interface Todos03Page {
    goto() : void,
    focusNewTodoField() : void,
    typeTodoAndEnter(todo: string) : void,
    enterTodo(todo: string) : void,
    seeNumberOfTodos(numberOfTodos: string) : void,
    seeEmptyTodoInput() : void,
    seeNthTodoEquals(nthTodo: string, todo: string) : void,
    seeFooter() : void,

  }


  export interface Todos04Page {
    goto() : void,
    enterTodo(todo: string) : void,
    markNthAsCompleted() : void,
    unmarkNthAsCompleted() : void,
    markAllAsCompleted() : void,
    clearCompleted() : void,
    filterAll() : void,
    filterActive() : void,
    filterCompleted() : void,
    seeNthTodoEquals() : void,
    seeNumberOfTodos(numberOfTodos: string) : void,
    seeEmptyTodoInput() : void,
    seeFooter() : void,
  ...
  export interface Todos05Page {
    ...
    filterActive() : void,
    filterCompleted() : void,
    editNthTodo(nthTodo: string, newTodoText: string) : void,
    deleteNthTodo(nthTodo: string) : void,
    seeNthTodoEquals() : void,
    seeNumberOfTodos(numberOfTodos: string) : void,
    seeEmptyTodoInput() : void,
    seeFooter() : void,
